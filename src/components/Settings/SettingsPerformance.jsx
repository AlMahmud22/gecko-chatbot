...
function SettingsPerformance() {
  ...
  useEffect(() => {
    ...
    const loadSettings = async () => {
      try {
        const settings = await window.electronAPI.getPerformanceSettings();
  ...
  const handleSave = () => {
    ...
    const newSettings = { threads, top_k: topK, top_p: topP, temperature };
    try {
      updatePerformanceSettings(newSettings);
      window.electronAPI.setPerformanceSettings(newSettings);
    } catch (err) {
